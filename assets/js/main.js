...
const betterLinks = (() => {
    $(window).on('load', () => {
        /**
         * Remove .html from website
         */
        // window.history.replaceState( null, null, document.location.href.split('.html')[0]);
        // window.onbeforeunload = function(event) {
        // window.history.replaceState( null, null, document.location.href + ".html");
        // };
